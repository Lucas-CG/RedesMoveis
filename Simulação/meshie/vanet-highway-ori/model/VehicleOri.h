  ...
  */
  class Vehicle : public ns3::Object
  {
    ...
    public:
      ...
      */
      void SetupWifi(const WifiHelper &wifi, const YansWifiPhyHelper &phy, const NqosWaveMacHelper &mac);
      /**
      ...
      */
      ...
      bool GetIsAp();
      void SetSendWarning(bool sendWarning);
      bool GetSendWarning();
      void SetStopWarning(bool stopWarning);
      bool GetStopWarning();
